      ...
      <div className="flex w-[1100px] flex-col gap-6">
        <div className="flex items-center justify-between">
          <div className="flex flex-col gap-1">
            ...
            <span className="text-sm text-zinc-400">Módulo "Conhecendo o Redux"</span>
          </div>
          ...
          <div className="flex-1">
            <div className="w-full bg-zinc-950 aspect-video">
              <ReactPlayer
                ...
                height="100%"
                controls
                src="https://www.youtube.com/watch?v=NwKaPuB4G_E"
            ...
            <div>
              ...
              >
                ...
                <div className="flex flex-col gap-1 text-left">
                  <strong className="text-sm">Conhecendo o Redux</strong>
              ...
              <nav className="relative flex flex-col gap-4 p-6">
                ...
                <button className="flex items-center gap-3 text-sm text-zinc-400">
                  <Video className="w-4 h-4 text-zinc-500" />
                  <span>Reducers no Redux</span>
                  <span className="ml-auto font-mono text-xs text-zinc-500">12:04</span>
                </button>
              </nav>
            </div>
